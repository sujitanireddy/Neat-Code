...
#Date Solved: March 4th 2026
"""
Notes: Had to revisit the video and understand the problem from scratch. I get the idea of the two pointer algorithm but purely for an interview perspective I will drill into the O(n) memory solution. 
Reason being, it's more intuitive and easy to explain to the intervener and not confuse myself. 
"""
def trap_revision(height):
...
#Testing
print(trap_revision(height=[0,1,0,2,1,0,1,3,2,1,2,1]))
